...
> Status: Nalira v0.14.2 memperkeras rangkuman hierarkis agar output terpotong dapat didiagnosis dengan aman dan setiap retry meminta persetujuan satu request tambahan. Production yang terverifikasi masih v0.14.1; acceptance rekaman panjang berhasil menyimpan transkrip sebelum rangkuman, sedangkan v0.14.2 menunggu push/deploy. Terakhir diverifikasi lokal: 28 Agustus 2026.
...
- Keputusan tersimpan dapat digunakan untuk membuat preview rangkuman privat. Materi pendek tetap memakai jalur single-call v0.13.1; source v0.14.x menghitung seluruh evidence lebih dulu dan, bila perlu, menawarkan maksimal 24 tahap berurutan tanpa sampling. Jumlah request terencana, destination, pacing, progress, pause/resume, dan retry eksplisit terlihat sebelum/dalam proses. Setiap retry meminta konfirmasi satu request tambahan. Preview tidak mengubah Guided, Tanya Materi, copy, ekspor, share, atau public link sampai pemilik memilih “Gunakan versi ini”.
